...
class Router {
  ...
  async renderContent(content) {
    ...
    // Clear app container and append parsed content
    this.appContainer.innerHTML = '';
    while (tempDiv.firstChild) {
      this.appContainer.appendChild(tempDiv.firstChild);
    }
  ...
  createErrorToast() {
    ...
    icon.innerHTML = '<svg class="toast-icon" width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>';
